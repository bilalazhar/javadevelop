...
public class MainActivity extends ActionBarActivity implements DialogInterface.OnDismissListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("LIMKOKWING UNIVERSITY");
        ...
        shortcut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("http://www.limkokwing.net/malaysia/academic/courses"));
                startActivity(i);
            }
        });
    }
    ...
    public void revealFromTop() {
        final int color = Color.parseColor("#363636");
